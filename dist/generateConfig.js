...
function generateProfileConfig(profile, links, backgroundColors, labels, neonColors, socialIcons, statusBar) {
    ...
    export const profileData = {
        ...
        userName: "${profile.userName}", // Nom affiché sur la page et dans le titre de l'onglet
        ...
        buttonThemeEnable: ${profile.buttonThemeEnable}, // 1 : Enable, 0 : Disable
        EnableAnimationArticle: ${profile.EnableAnimationArticle}, // 1 : Enable, 0 : Disable
        EnableAnimationButton: ${profile.EnableAnimationButton}, // 1 : Enable, 0 : Disable
        EnableAnimationBackground: ${profile.EnableAnimationBackground}, // 1 : Enable, 0 : Disable
        backgroundSize: ${profile.backgroundSize}, // En pourcentage
        selectedThemeIndex: ${profile.selectedThemeIndex}, // Thème sélectionné            (voir ci-dessous)
        selectedAnimationIndex: ${profile.selectedAnimationIndex}, // Animation de l'article       (voir ci-dessous)
        selectedAnimationButtonIndex: ${profile.selectedAnimationButtonIndex}, // Animation des boutons        (voir ci-dessous)
        selectedAnimationBackgroundIndex: ${profile.selectedAnimationBackgroundIndex}, // Animation de l'arrière-plan  (voir ci-dessous)
        animationDurationBackground: ${profile.animationDurationBackground}, // Durée de l'animation en secondes
        delayAnimationButton: ${profile.delayAnimationButton}, // Délai de l'animation en secondes
        canvaEnable: ${profile.canvaEnable}, // 1 : Enable, 0 : Disable
        selectedCanvasIndex: ${profile.selectedCanvasIndex}, // Animation du canva (voir ci-dessous) - Matrix Effect
    };
