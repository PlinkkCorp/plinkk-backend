  ...
  replyOptions: {
    rewriteRequestHeaders: (req, headers) => {
      return {
        ...
        "user-agent": headers["user-agent"] || req.headers["user-agent"] || "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",
        referer: req.headers.referer || "https://plinkk.fr/",
        origin: req.headers.origin || "https://plinkk.fr",
        accept: headers["accept"] || "text/javascript, application/javascript, */*;q=0.1",
      };
    },
  },
});
